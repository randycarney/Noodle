function ellipse_t = fit_ellipse( x,y,axis_handle,color,alphaValue)
%
...
%     plot( new_horz_line(1,:),new_horz_line(2,:),color );
    fill( rotated_ellipse(1,:),rotated_ellipse(2,:),color,'EdgeColor',color,'LineStyle','--','FaceAlpha',alphaValue);
